...
class Quarter extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['district_id', 'region_id', 'name', 'addres', 'leader', 'phone'];
    ...
    public static function boot() {
        ...
        static::deleting(function($quarter) {
             $quarter->streets()->delete();
             $quarter->homes()->delete();
             $quarter->stored_products()->delete();
             $quarter->planted_products()->delete();
             $quarter->expected_products()->delete();
        }); 
    }
